...
declare module "@salesforce/schema/AccountChangeEvent.Total_Cars_Bought__c" {
  const Total_Cars_Bought__c:number;
  export default Total_Cars_Bought__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Discount__c" {
  const Discount__c:number;
  export default Discount__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Discount_Percent__c" {
  const Discount_Percent__c:number;
  export default Discount_Percent__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Active_Buyer__c" {
  const Active_Buyer__c:boolean;
  export default Active_Buyer__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Level__pc" {
  const Level__pc:string;
  export default Level__pc;
}
declare module "@salesforce/schema/AccountChangeEvent.Languages__pc" {
